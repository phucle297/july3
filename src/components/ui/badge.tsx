  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        green_pastel_9:
          "border-transparent bg-[#61e298]  dark:text-[#064e3b] text-[#f9fafb]",
        green_pastel_10:
          "border-transparent bg-[#4ad87f]  dark:text-[#064e3b] text-[#f9fafb]",
        green:
          "border-transparent bg-[#16a34a] dark:text-[#064e3b] text-[#f9fafb]",
        ...
        violet_pastel_8:
          "border-transparent bg-[#b2b2ff]  dark:text-[#3b1e8a]  text-[#f9fafb]",
        violet_pastel_9:
          "border-transparent bg-[#aaaafe]  dark:text-[#3b1e8a]  text-[#f9fafb]",
        violet_pastel_10:
          "border-transparent bg-[#a2a2fe]  dark:text-[#3b1e8a]  text-[#f9fafb]",
        violet:
          "border-transparent bg-[#9a9afe] dark:text-[#3b1e8a]  text-[#f9fafb]",
        ...
        red_pastel_9:
          "border-transparent bg-[#ff8282] text-[#f9fafb] dark:text-[#610404]",
        red_pastel_10:
          "border-transparent bg-[#ff7676] text-[#f9fafb] dark:text-[#610404]",
